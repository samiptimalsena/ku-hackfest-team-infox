...
def save_txts_from_txt_done_data(
    ...
    with open('/home/maspi/code/KU_HACKFEST/INFOX_TTS_TRAIN/vakyansh-tts/config/glow/base_blank.json', 'r') as jfile:
    ...
    with open(f'/home/maspi/code/KU_HACKFEST/INFOX_TTS_TRAIN/vakyansh-tts/config/glow/{new_config_name}.json','w+') as jfile:
        json.dump(json_config, jfile)
    
    print(f"Characters: {chars}")
    print(f"Len of vocab: {len(chars)}")
    print(f"Punctuation: {punct_with_space}")
    print(f"Config file is stored at /home/maspi/code/KU_HACKFEST/INFOX_TTS_TRAIN/vakyansh-tts/config/glow/{new_config_name}.json")
